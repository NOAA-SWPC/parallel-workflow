...
export NSSTBF=${NSSTBF:-$COMIN_DUMP/nsstbufr.$CDUMP.$CDATE}
export PREPQC=${PREPQC:-$COMIN_DUMP/prepqc.$CDUMP.$CDATE}
export PREPQCPF=${PREPQCPF:-$COMIN_DUMP/prepbufr.acft_profiles.$CDUMP.$CDATE}
